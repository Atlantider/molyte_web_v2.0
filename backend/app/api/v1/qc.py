...
def create_qc_job(
    ...
    # QC引擎配置
    config["qc_engine"] = job_data.qc_engine or "gaussian"
    
    # XTB预优化配置（保存为use_xtb_preoptimization以匹配后端worker期望的字段名）
    config["use_xtb_preoptimization"] = job_data.use_xtb_preopt or False
