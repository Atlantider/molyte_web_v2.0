...
from app.api.v1 import reaction_network, reaction_network_analytics
...
# Include Reaction Network routers
app.include_router(
    reaction_network.router,
    prefix="/api/v1/reaction-network",
    tags=["reaction-network"]
)
app.include_router(
    reaction_network_analytics.router,
    prefix="/api/v1/reaction-network",
    tags=["reaction-network-analytics"]
)
