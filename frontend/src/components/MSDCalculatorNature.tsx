    ...
    return (
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, color: token.colorTextSecondary, marginBottom: 12, fontWeight: 600 }}>
          ...
          <Row gutter={12}>
            <Col span={12}>
              <div style={{
                ...
                <div style={{ fontSize: 11, color: token.colorTextSecondary, marginBottom: 6 }}>全部数据</div>
                <div style={{ fontSize: 22, fontWeight: 700, color: color }}>
                  {(fullD * 1e7).toFixed(2)}
                </div>
                <div style={{ fontSize: 10, color: token.colorTextSecondary, marginTop: 4 }}>×10⁻⁷ cm²/s</div>
              </div>
            </Col>
            <Col span={12}>
              <div style={{
                ...
                <div style={{ fontSize: 11, color: token.colorTextSecondary, marginBottom: 6 }}>后半段</div>
              ...
              {data.ionic_conductivity && (
                <Col span={12}>
                  <div style={{
                    ...
                    <div style={{ fontSize: 11, color: token.colorTextSecondary, marginBottom: 6 }}>离子电导率</div>
                    <div style={{ fontSize: 18, fontWeight: 700, color: '#16a34a' }}>
                      {(data.ionic_conductivity * 1e3).toFixed(2)}
                    </div>
                    <div style={{ fontSize: 10, color: token.colorTextSecondary, marginTop: 4 }}>mS/cm</div>
                  </div>
                </Col>
              )}
              {data.mobility && (
                <Col span={data.ionic_conductivity ? 12 : 24}>
                  <div style={{
                    ...
                    <div style={{ fontSize: 11, color: token.colorTextSecondary, marginBottom: 6 }}>离子迁移率</div>
                    <div style={{ fontSize: 18, fontWeight: 700, color: '#0891b2' }}>
                      {(data.mobility * 1e4).toFixed(2)}
                    </div>
                    <div style={{ fontSize: 10, color: token.colorTextSecondary, marginTop: 4 }}>×10⁻⁴ cm²/(V·s)</div>
                  </div>
                </Col>
              )}
            </Row>
        ...
        <Row gutter={8}>
          <Col span={12}>
            <div style={{ padding: 12, backgroundColor: isDark ? 'rgba(255,255,255,0.04)' : token.colorFillQuaternary, borderRadius: 6, textAlign: 'center', border: `1px solid ${token.colorBorder}` }}>
              <div style={{ fontSize: 11, color: token.colorTextSecondary, marginBottom: 4 }}>数据点数</div>
              <div style={{ fontSize: 18, fontWeight: 600, color: token.colorText }}>{data.time.length}</div>
            </div>
          </Col>
          <Col span={12}>
            <div style={{ padding: 12, backgroundColor: isDark ? 'rgba(255,255,255,0.04)' : token.colorFillQuaternary, borderRadius: 6, textAlign: 'center', border: `1px solid ${token.colorBorder}` }}>
              <div style={{ fontSize: 11, color: token.colorTextSecondary, marginBottom: 4 }}>最大 MSD</div>
              <div style={{ fontSize: 18, fontWeight: 600, color: token.colorText }}>{Math.max(...data.msd_total).toFixed(1)}</div>
            </div>
          </Col>
        </Row>

        <div style={{ padding: 12, backgroundColor: isDark ? 'rgba(255,255,255,0.04)' : token.colorFillQuaternary, borderRadius: 6, textAlign: 'center', border: `1px solid ${token.colorBorder}` }}>
          <div style={{ fontSize: 11, color: token.colorTextSecondary, marginBottom: 4 }}>时间范围</div>
                  ...
                  <div style={{ padding: DASHBOARD_STYLES.cardPadding }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: token.colorTextSecondary }}>mS/cm</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div style={{ padding: DASHBOARD_STYLES.cardPadding }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: token.colorTextSecondary }}>无量纲</div>
                      </div>
                    </div>
                  </div>
                </div>
